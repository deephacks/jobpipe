...
Unlike other workflow schedulers, Jobpipe is a minimal library that tries hard to be unopinionated on how users should build their applications with regards to logging, configuration, monitoring, dependency injection, persistence, security, thread execution etc.
